...
int main()
{
    ...
    // Resizing vector V.
    vc = resize_Complex_vector(vc, 10, 5);
    printf("\nVector V resized (new_size < old_size):\n");
    show_Complex_vector(vc, 5);

    vc = resize_Complex_vector(vc, 5, 10);
    printf("\nVector V resized (new_size > old_size):\n");
    llenar_Complex_vector(vc, 10);
    show_Complex_vector(vc, 10);
    ...
    vc = insertItem_Complex_vector(vc, 10, 7, value);
    printf("\nVector V (with a new item):\n");
    show_Complex_vector(vc, 11);

    // Removing an item from vector V.
    vc = removeItem_Complex_vector(vc, 11, 7);
    printf("\nVector V (without an old item):\n");
    show_Complex_vector(vc, 10);
